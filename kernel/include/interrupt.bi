...
dim shared IDT_SEGMENT(0 to &h3F)   as IDT_ENTRY
dim shared IRQ_HANDLERS(0 to &h3F)  as function(stack as irq_stack ptr) as irq_stack ptr


declare sub interrupt_tab()
declare sub IRQ_RESTORE(irq as IRQ_STACK ptr)