...
type IPCEndPoint    field = 1
    ...
    declare static function CreateAnonymous(th as thread ptr,entry as unsigned integer,sync as unsigned integer) as IPCEndPoint ptr
...
declare sub IPC_THREAD_TERMINATED(t as unsigned integer)